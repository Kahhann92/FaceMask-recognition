...
def main():
    ...
    parser.add_argument('--ann_dir', type=str, default="test-images",
                        help='path to annotation files directory. It is not need when use --ann_paths_list')
    parser.add_argument('--ann_ids', type=str, default="test-images/list.txt",
                        help='path to annotation files ids list. It is not need when use --ann_paths_list')
    parser.add_argument('--ann_paths_list', type=str, default=None,
                        help='path of annotation paths list. It is not need when use --ann_dir and --ann_ids')
    parser.add_argument('--labels', type=str, default='test-images/labels.txt',
                        help='path to label list.')
    parser.add_argument('--output', type=str, default="test-images/test-images.json", help='path to output json file')
