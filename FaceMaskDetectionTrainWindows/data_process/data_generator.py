...
attach_dir = '/Users/yaofeifan/Downloads/Media/FaceMaskDetectionTrainWindows/attach_data/mask'
    ...
    while True:
        ...
        try:
            ...
            if train_mode:
                ...
                for d in batch_data:
                    processed_data.append(image_process_train(d))
            else:
                for d in batch_data:
                    processed_data.append(image_process_test(d))
